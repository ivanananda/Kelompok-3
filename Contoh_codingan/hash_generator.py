...
class Papu:
    def __init__(self, master):
        ...
        self.master = master
        master.title("HASHING GUI BY IYAN DAN IVAN")

        self.label1=Label(master,text="Input",font=14,activeforeground="red")
       ...
       # self.button1=Button(master,text="Show_all_hash",font=20,bg="pink")
        ...
        self.button4 = Button(master, text="HAPUS HASHING", font=20, padx=20, bg="deep sky blue", pady=20,command=self.clear)
        self.button4.place(x=40, y=320)
...
#
        ...
        self.label11=Label(master,text="HASH GENERATOR by ==> IYAN DAN IVAN",font=20)
